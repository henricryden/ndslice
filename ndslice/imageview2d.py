...
class ImageView2D(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, view=None, imageItem=None):
        ...
        levelMode : str
            Level mode for histogram ('mono', 'rgb', 'rgba')
        """
        ...
        # Set custom fill color for the histogram
        #fill_color = (0, 0, 200, 150)
        #self.histogram.fillHistogram(fill=True, level=0.0, color=fill_color)
...
#        self.histogram.setImageItem(self.imageItem)
#        self.histogram.setLevelMode(levelMode)
