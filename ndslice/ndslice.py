...
class NDSliceWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, data, *args, **kwargs):
        ...
        if np.iscomplexobj(self.data) or True:
...
# channel_group_widget.setStyleSheet("QGroupBox { background-color: #F7FFE6; border: 1px solid #ccc; margin: 2px; padding: 5px; }")
# processing_group_widget.setStyleSheet("QGroupBox { background-color: #F4E6FF; border: 1px solid #ccc; margin: 2px; padding: 5px; }")
# display_group_widget.setStyleSheet("QGroupBox { background-color: #e6f3ff; border: 1px solid #ccc; margin: 2px; padding: 5px; }")
